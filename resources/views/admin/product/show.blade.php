                                ...
                                <div class="inner">
                                    ...
                                    <div class="product-action-wrapper d-flex-center">
                                        ...
                                        <ul class="product-action d-flex-center mb--0">
                                            <li class="add-to-cart"><a href="{{route('products.edit',$product)}}" class="axil-btn btn-bg-primary">Modify</a></li>
                                            <li class="remove-wishlist">
                                                <form id="deleteProductForm" style='display:inline;' method="post" action="{{route('products.destroy',$product)}}" >
                                                    @csrf
                                                    @method('delete')
                                                    <a class="axil-btn wishlist-btn" style="background-color:red;" onclick="document.getElementById('deleteProductForm').submit();"><i class="far fa-times text-white"></i></a>
                                                </form>
